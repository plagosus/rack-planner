...
interface Server3UProps {
    isPowered?: boolean;
    rackWidth?: RackWidth;
}

export const Server3U = ({ isPowered, rackWidth = '19inch' }: Server3UProps) => {
    ...
    return (
        <div className="w-full h-full relative flex items-center">
            ...
            {/* Right Side: Even Larger Fan Grilles */}
            <div className="w-full flex justify-end items-center gap-3 pr-4">
                {fans.map((i) => (
                    <div key={i} className={`${rackWidth === '19inch' ? 'w-49' : 'w-40'} h-40 rounded-md border-2 border-white/10 flex items-center justify-center bg-black/20`}>
